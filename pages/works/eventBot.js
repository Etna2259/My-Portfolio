    ...
    <Container maxW="container.md">
      <Text fontSize={{ base: "18px", md: "21px" }}>
        ...
        <Paragraph>
          ...
          Discord announcement about in-game events occuring in Lost Ark. Lost
          Ark is a MMORPG online game that has many "World Activites" that
          occurs during specific in-game time which is cumbersome to keep track
          of. In order to solve that, he decided to make a bot that would notify
          everyone in the server automatically.
        </Paragraph>
