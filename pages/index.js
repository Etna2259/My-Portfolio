      ...
      <Container maxW="container.sm">
        <Text fontSize={{ base: "15px", md: "21px" }}>
          ...
          <Section delay={0.1}>
            ...
            <Paragraph>
              My name is Quan, currently a 3rd year student at Tokyo
              International University majoring in Digital Business and
              Innovations. I am building my skillset aiming to become a Data
              Analyst or Data Scientist position. I have been learning Python, R
              and Tableau for close to 2 years with experience in Data
              Visualizations and Statistics. Aside from that, I started taking
              an interest in React.js, Next.js which is the foundation of page
              that you are checking out right now :)
            </Paragraph>
